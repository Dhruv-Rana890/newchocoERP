...
class RawMaterialController extends Controller
{
    ...
    public function rawMaterialData(Request $request)
    {
        ...
        $order = 'raw_materials.' . $columns[$request->input('order.0.column')];
        ...
        foreach ($raw_materials as $raw_material) {
            ...
            $nestedData['brand'] = $raw_material->brand ? $raw_material->brand->title : 'N/A';
            ...
            $nestedData['price'] = $raw_material->price;
