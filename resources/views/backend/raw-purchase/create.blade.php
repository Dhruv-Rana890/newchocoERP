            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'raw-purchases.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $("ul#rawmaterial #raw-purchase-create-menu").addClass("active");

    $("#payment").hide();
    $("#cheque").hide();

    // array data depend on warehouse
    var raw_material_code = [];
    var raw_material_name = [];
    var raw_material_qty = [];
